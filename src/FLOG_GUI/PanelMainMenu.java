...
public class PanelMainMenu extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnStart1 = new javax.swing.JLabel();
        ...
        btnStart1.setBackground(new java.awt.Color(0, 204, 255));
        btnStart1.setFont(new java.awt.Font("Trebuchet MS", 0, 30)); // NOI18N
        btnStart1.setForeground(new java.awt.Color(255, 255, 255));
        btnStart1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        btnStart1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/btn_startgame_n.png"))); // NOI18N
        btnStart1.setPreferredSize(new java.awt.Dimension(282, 36));
        add(btnStart1, new org.netbeans.lib.awtextra.AbsoluteConstraints(312, 165, 288, 70));

        btnMultiPlayer.setText("MultiPlayer");
        add(btnMultiPlayer, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 89, 280, 50));
