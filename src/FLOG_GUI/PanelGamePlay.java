...
public class PanelGamePlay extends javax.swing.JPanel {
    ...
    private void lblL1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblL1MouseReleased
    ...
    private void lblL12MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblL12MouseClicked
    ...
    private void txtAnswerMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtAnswerMouseReleased
    ...
    private void lblL2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblL2MouseClicked
    ...
    private void lblL3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblL3MouseClicked
    ...
    private void lblL4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblL4MouseClicked
    ...
    private void lblL5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblL5MouseClicked
    ...
    private void lblL6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblL6MouseClicked
    ...
    private void lblL7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblL7MouseClicked
    ...
    private void lblL8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblL8MouseClicked
    ...
    private void lblL9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblL9MouseClicked
    ...
    private void lblL10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblL10MouseClicked
    ...
    private void lblL11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblL11MouseClicked
